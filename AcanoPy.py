...
class Acano:
	...
	def get_coSpace_members(self, coSpace_id, parameters = {}):
		...
		:Example: print(a.get_coSpace_members("3b8dfa05-f7b6-41f2-b14a-739a0d015b90"))
	...
	def modify_coSpace_member(self, coSpace_id, coSpace_user_id, payload = {}):
		"""Modify the details of a member within a coSpace, using the coSpace ID as the identifier.

		:param coSpace_id: The ID of the coSpace in which to modify a member. This can be returned from the get_coSpaces()["coSpaces"]["coSpace"][i]["@id"]
		:type coSpace_id: String

		:param payload: Details the member to add. 
		:type payload: Dict
	...
	def get_coSpace_member(self, coSpace_id, coSpace_user_id):
		"""Get a member that exists within a coSpace, using the coSpace ID and coSpace User ID as the identifiers.

		:param coSpace_id: The ID of the coSpace in which to modify a member. This can be returned from the get_coSpaces()["coSpaces"]["coSpace"][i]["@id"]
		:type coSpace_id: String

		:param coSpace_id: The ID of the user to modify. 
		:type coSpace_id: String
	...
	def post_message_to_coSpace(self, coSpace_id, payload = {}):
		"""Post a message to a coSpace, identified by the coSpace ID.

		:param coSpace_id: The ID of the coSpace in which to modify a member. This can be returned from the get_coSpaces()["coSpaces"]["coSpace"][i]["@id"]
		:type coSpace_id: String

		:param payload: The ID of the user to modify. 
		:type coSpace_id: dict

		:Example:

		a.post_message_to_coSpace("3b8dfa05-f7b6-41f2-b14a-739a0d015b90", payload = {
			"message" : "Hello world!",
			"from" : "George"
			})
